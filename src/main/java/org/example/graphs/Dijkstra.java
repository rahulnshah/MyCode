...
public class Dijkstra {
    public List<Integer> dijkstra(int V, int[][] edges, int src) {
        ...
        Since you want the shortest distance from src to all nodes, you will maintain a min heap
        T.C: O(ElogV), where E is the number of edges and V is the number of nodes
        S.C: O(V + E) for the adjList, O(V) for the dist array, O(V) for the min heap
        */
